/* =========================================================
   FocusLab · Icon Sprite
   -----
   Lucide icons (ISC License) - 内联到 DOM, 无 CDN 依赖
   用法:
     <span data-icon="play" data-size="20"></span>
   或在 JS 中:
     Icon.mount(); // 扫描 DOM 并替换所有 data-icon 占位
   ========================================================= */
...
(function (global) {
  const paths = {
    ...
    'sparkles':    '<path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3z"/><path d="M19 17l.6 1.6L21 19l-1.4.4L19 21l-.6-1.6L17 19l1.4-.4L19 17z"/>',
    ...
    'circle-pause':'<circle cx="12" cy="12" r="10"/><line x1="10" y1="15" x2="10" y2="9"/><line x1="14" y1="15" x2="14" y2="9"/>',
  ...
  function create(name, options = {}) {
    ...
    const body = paths[name] || '<circle cx="12" cy="12" r="10"/>';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${stroke}" stroke-linecap="round" stroke-linejoin="round" class="${cls}" aria-hidden="true">${body}</svg>`;
  }
  ...
  function mount(root = document) {
    root.querySelectorAll('[data-icon]').forEach((el) => {
      ...
      const stroke = parseFloat(el.dataset.stroke || '2');
      const cls = el.dataset.className || '';
      el.innerHTML = create(name, { size, stroke, className: cls });
    });
  }

  const Icon = { create, mount, paths };
  global.Icon = Icon;
